...
void main()
{
    ...
    vec4 worldPos = model * vec4(aPos+texture(displacementmap, aTexCoord).rgb*aNormal*displacement_coefficient, 1.0);
	...
	vec3 B = vec3(N[1]*T[2]-T[1]*N[2],T[0]*N[2]-N[0]*T[2],N[0]*T[1]-T[0]*N[1]);
